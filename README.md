...
[![Build](https://github.com/ao-apps/semanticcms-autogit-all/actions/workflows/build.yml/badge.svg?branch=1.x)](https://github.com/ao-apps/semanticcms-autogit-all/actions?query=workflow%3ABuild)
